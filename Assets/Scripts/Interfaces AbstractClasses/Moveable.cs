...
namespace WorldBuilder
{
    public class Moveable : MonoBehaviour
    {
        ...
        Vector3 _randLocalPos = new Vector3(0f, 1f, 0f);
        private void idleMovement()
        {
            ...
            if (dir == Tile.TileMovementDirection.Center || coolDown > 0)
            {
                ...
                {
                    _idleMoveTimer -= 1 * Time.deltaTime;
        ...
        /// <summary>
        /// time before the unit decides the next move, this excistes for exploit protections
        /// </summary>
